...
test_that("Finding rank acceptabilities indices work properly.", {
  ...
  results <- findRankAcceptabilityIndices(perf =performances, 
                                               strict.vf = TRUE,
  ...
  expect_that(results[1,6],is_equivalent_to(100))
  expect_that(results[3,3],is_equivalent_to(100))
  expect_that(results[4,2],is_equivalent_to(100))
  expect_that(results[6,1],is_equivalent_to(100))
  #print("Finding neccessary and possible relations OK")
})

test_that("Finding ranks acceptabilities indices work properly - characteristic points.", {
  performances <- getPerformances2()
  #hierarchy.data <- getHierarchyData()
...
test_that("Finding ranks acceptabilities indices work properly - characteristic points - cost.", {
...
test_that("Finding ranks acceptabilities indices work properly - cost.", {
  performances <- getPerformancesCost()
  #hierarchy.data <- getHierarchyData()
...
test_that("Finding necessary and possible relations work properly - Hierarchical.", {
  ...
  expect_that(results$nodes1[1,6],is_equivalent_to(100))
  expect_that(results$nodes1[2,3],is_equivalent_to(100))
  expect_that(results$nodes1[3,2],is_equivalent_to(100))
  expect_that(results$nodes1[4,4],is_equivalent_to(100)) 
  expect_that(results$nodes1[5,5],is_equivalent_to(100))   
  expect_that(results$nodes1[6,1],is_equivalent_to(100)) 
...
test_that("Finding necessary and possible relations work properly - Hierarchical - cost.", {
  ...
  results <- findRankAcceptabilityIndicesHierarchical(perf =performances, 
                                                           ...
                                                           strong.intensities.of.prefs = NULL, weak.intensities.of.prefs = NULL, indif.intensities.of.prefs = NULL, 
                                                           rank.related.requirements = NULL,
                                                           nums.of.characteristic.points=c(), criteria=c("c","c","g","c"), num.of.samples=50, hierarchy.data=hierarchy.data)
  
  expect_that(results$nodes1[1,1],is_equivalent_to(100))
  expect_that(results$nodes1[2,4],is_equivalent_to(100))
  expect_that(results$nodes1[3,5],is_equivalent_to(100))
  expect_that(results$nodes1[4,3],is_equivalent_to(100)) 
  expect_that(results$nodes1[5,2],is_equivalent_to(100))   
  expect_that(results$nodes1[6,6],is_equivalent_to(100)) 
  #print("Finding neccessary and possible relations - Hierarchical OK")
})